...
public:
 ...
 void tampilkanBarang() {
    ...
    for (size_t i = 0; i < barang.size(); i++) {
        ...
        if (b.status == "Di Gudang") {
            ...
            cout << std::left
                      << setw(15) << b.namaPenggadai
                      << setw(20) << b.nama
                      << setw(20) << b.nomorTransaksi
                      << setw(12) << b.status
                      << setw(15) << std::fixed << std::setprecision(2) << b.harga
                      << setw(15) << bufferGadai
                      << setw(20) << bufferTempo
                      << setw(12) << std::fixed << std::setprecision(2) << b.hitungBunga()
                      << endl;
        }
    }
 ...
 void tampilkanHargaBarang() {
    ...
    void inputBarangBaru() {
        ...
        getline(std::cin, namaPenggadai);
        cout << "Masukkan Nama Barang: ";
        getline(std::cin, nama);
        cout << "Masukkan Nomor Transaksi: ";
        getline(std::cin, nomorTransaksi);
        ...
        std::tm tJTempo = {};
        tJTempo.tm_mday = tjg;
        tJTempo.tm_mon = tjm - 1;
        tJTempo.tm_year = tjy - 1900;

        Barang b(namaPenggadai,
		nama, 
		nomorTransaksi, 
		status, 
		harga, 
...
tm tj1 = tg1;
tj1.tm_mday = 4;
Barang b1("SURYA PRIMA", "Air Cooler", "FPB-0001", "Di Gudang", 25000, tg1, tj1, 0.1);
...
tm tj2 = tg2;
tj2.tm_mday = 4;
Barang b2("TEDY BATTERY", "Accu 150 Ampere Incco", "FPB-0002", "Keluar", 1400000, tg2, tj2, 0.1);
...
tm tj3 = tg3;
tj3.tm_mday = 4;
Barang b3("SURYA PRIMA", "Shock breaker", "FPB-0003", "Di Gudang", 500000, tg3, tj3, 0.1);
...
tm tj4 = tg4;
tj4.tm_mday = 4;
Barang b4("INTERTRUCK PARTS", "Booster Rem MERCY", "FPB-0004", "Di Gudang", 1299450, tg4, tj4, 0.1);
...
tm tj5 = tg5;
tj5.tm_mday = 4;
Barang b5("JAYA MANDIRI DIESEL", "As Stang rem", "FPB-0005", "Di Gudang", 125000, tg5, tj5, 0.1);
...
tm tj6 = tg6;
tj6.tm_mday = 4;
Barang b6("TEKNIKA COKRA", "Anting-Anting Rem", "FPB-0006", "Di Gudang", 395000, tg6, tj6, 0.1);
...
tm tj7 = tg7;
tj7.tm_mday = 4;
Barang b7("MORO JAYA TEKNIK", "Adaptor 3/4 Male", "FPB-0007", "Di Gudang", 30000, tg7, tj7, 0.1);
...
tm tj8 = tg8;
tj8.tm_mday = 4;
Barang b8("WANAJAYA BAN", "Ban Dalam 900-20 GT", "FPB-0008", "Di Gudang", 285000, tg8, tj8, 0.1);
...
tm tj9 = tg9;
tj9.tm_mday = 4;
Barang b9("SURYA PRIMA", "Bohlam H4 BOSS", "FPB-0009", "Di Gudang", 30000, tg9, tj9, 0.1);
...
tm tj10 = tg10;
tj10.tm_mday = 4;
Barang b10("TEKNIKA COKRA", "Dinamo Amper", "FPB-00010", "Di Gudang", 510000, tg10, tj10, 0.1);
...
tm tj11 = tg11;
tj11.tm_mday = 4;
Barang b11("INTERTRUCK PARTS", "Filter Udara Besar Volvo", "FPB-00011", "Di Gudang", 350000, tg11, tj11, 0.1);
...
tm tj12 = tg12;
tj12.tm_mday = 4;
Barang b12("SURYA PRIMA", "Air cooler", "FPB-00012", "Di Gudang", 25000, tg12, tj12, 0.1);
...
tm tj13 = tg13;
tj13.tm_mday = 4;
Barang b13("SURYA PRIMA", "Bohlam H4 BOSS", "FPB-00013", "Di Gudang", 30000, tg13, tj13, 0.1);
...
tm tj14 = tg14;
tj14.tm_mday = 4;
Barang b14("INTERTRUCK PARTS", "King Pin MERCY", "FPB-00014", "Di Gudang", 375000, tg14, tj14, 0.1);
...
tm tj15 = tg15;
tj15.tm_mday = 4;
Barang b15("INTERTRUCK PARTS", "Kaca Spion mercy", "FPB-00015", "Di Gudang", 120000, tg15, tj15, 0.1);
...
tm tj16 = tg16;
tj16.tm_mday = 4;
Barang b16("TEKNIKA COKRA", "Anting-Anting Rem", "FPB-00016", "Di Gudang", 395000, tg16, tj16, 0.1);
...
tm tj17 = tg17;
tj17.tm_mday = 4;
Barang b17("TEDY BATTERY", "Accu 150 Ampere Incco", "FPB-00017", "Di Gudang", 1400000, tg17, tj17, 0.1);
...
tm tj18 = tg18;
tj18.tm_mday = 4;
Barang b18("WANAJAY BAN", "Ban Dalam 900-20GT", "FPB-00018", "Di Gudang", 285000, tg18, tj18, 0.1);
...
tm tj19 = tg19;
tj19.tm_mday = 4;
Barang b19("INTERTRUCK PARTS", "Kaca Pintu LH VOLVO", "FPB-00019", "Di Gudang", 385000, tg19, tj19, 0.1);
...
tm tj20 = tg20;
tj20.tm_mday = 4;
Barang b20("INTERTRUCK PARTS", "Filter Solar (BOSCH)", "FPB-00020", "Di Gudang", 45000, tg20, tj20, 0.1);
